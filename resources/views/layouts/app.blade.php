...
<html lang="en">
  ...
  <body class="bg-gray-100 text-gray-800">
    ...
    <nav class="h16 flex justify-end py-4 px-16">
      ...
      <a href="{{route('products.create')}}" class="text-white rounded px-4 pt-1 h-10 bg-blue-500  font-semibold mx-2 hover:bg-blue-600">Create</a>
    </nav>
